...
function GlassyCard({title, description, logo, type}) {
  return (
    <>
                <div className="parent mt-4">
                    <div className="card-services">
                        <div className="logo">
                            <span className={`circle-${type} circle1`}></span>
                            <span className={`circle-${type}  circle2`}></span>
                            <span className={`circle-${type}  circle3`}></span>
                            <span className={`circle-${type}  circle4`}></span>
                            <span className={`circle-${type}  circle5`}>
                                <img className='svg' src={logo} alt='MERN icon'></img>
                            </span>

                        </div>
                        <div className={`glass-${type}`}></div>
                        <div className="content">
                            <span className={`title-${type} display-6 text-color`}>{title}</span>
